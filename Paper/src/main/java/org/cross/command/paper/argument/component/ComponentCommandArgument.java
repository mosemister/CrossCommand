...
public class ComponentCommandArgument<Src> implements BrigadierCommandArgument<Src, Component> {
    ...
    @Override
    public @NotNull Component process(@NotNull CommandContextMutable commandContext, @NotNull ArgumentContext context) throws ArgumentException {
